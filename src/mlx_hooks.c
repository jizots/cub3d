...
/*   Updated: 2023/10/19 19:29:14 by sotanaka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	human_walk2(t_human *human, t_mlx *mlx, int keycode, double speed)
{
	t_point2df		old_pos;
...
static void	human_walk(t_human *human, t_mlx *mlx, int keycode, double speed)
{
	t_point2df		old_pos;
	...
	else if (keycode == KEY_W)
	{
		...
		human_walk2(human, mlx, keycode, speed);
}
...
int	cub3d_mlx_keypush(int keycode, t_meta *meta)
{
	...
	if (keycode == KEY_ESC)
	{
		...
		human_walk(&(meta->human), &(meta->mlx), keycode, meta->tile_size / 4.0);
